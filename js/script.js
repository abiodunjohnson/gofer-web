$(document).ready(function() {
  ...
  $("#taba").click(function() {
    $(".tab-2.a").addClass('above')
    $(".tab-2.ab").removeClass('above')
    $(".tab-2.ac").removeClass('above')
    $(".tab-2.ad").removeClass('above')
  })

  $("#tabb").click(function() {
    $(".tab-2.ab").addClass('above')
    $(".tab-2.a").removeClass('above')
    $(".tab-2.ac").removeClass('above')
    $(".tab-2.ad").removeClass('above')
  })
